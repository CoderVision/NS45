...
//using NtccSteward.Core.Models.Services;
//using System;
...
//namespace NtccSteward.Api.Services
//{
//    [Route("api/message")]
...
//        public MessageApiController(IMessageRepository repository, ILogger logger)
//        {
...
//        [HttpPost("SendEmail")]
//        public async Task<string> SendEmailAsync(int churchId, string recipient, string subject, string body)
//        {
...
//        [HttpPost("SendSms")]
//        public async Task<string> SendSmsAsync(int churchId, string recipient, string subject, string body)
//        {
