...
function GetPhoneNumbers(id) {
    ...
    for (var i = 0; i < addys.childElementCount; i++) {
        ...
        for (var n = 0; n < fields.length; n++) {
            ...
            if (fields[n].id.indexOf("phoneNumber") > -1)
